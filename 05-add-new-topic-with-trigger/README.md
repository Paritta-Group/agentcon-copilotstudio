# 🚨 Mission 05: Add new topic with trigger and nodes
...
### 5.3 Add a tool using a connector
...
This is the end of **Lab 05 - Add a new topic with conversation nodes**, select the link below to move to the next lesson. We'll expand on the use case in this lab in the following lesson's lab.

⏭️ [Move to **Enhance user interactions with Adaptive Cards** lesson](../06-add-adaptive-card/README.md)
