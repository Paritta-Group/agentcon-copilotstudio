# 🚨 Mission 08: Add Event Triggers - Enable autonomous agent capabilities
...
### 8.3 Create a tool for email acknowledgment
...
🚀 **Next up**: In our next lesson, you'll learn how to [publish your agent](../09-publish-your-agent/README.md) to Microsoft Teams and Microsoft 365 Copilot, making it available to your entire organization!

⏭️ [Move to **Publish your agent** lesson](../09-publish-your-agent/README.md)
