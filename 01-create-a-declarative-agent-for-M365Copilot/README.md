...
## 🧪 Lab 01: Build a declarative agent in Microsoft Copilot Studio for Microsoft 365 Copilot
...
- [1.1 Create a declarative agent](#11-create-a-declarative-agent)
- [1.2 Create and add a prompt for your declarative agent](#12-create-and-add-a-prompt-for-your-declarative-agent)
...
1. Navigate to [https://copilotstudio.microsoft.com/](https://copilotstudio.microsoft.com/) and sign in using your credentials. Make sure to switch to the environment that you're using for these labs.
...
1. We'll then see the create agent experience where we need to enter some details. For the name of the agent, enter the following,
    ...
    > 🤝 **Sharing a login?** Append your initials, e.g. `Contoso Tech Support Pro - ABC`.
...
### 1.2 Create and add a prompt for your declarative agent
...
1. Select the **chevron icon** next to the **Model** to see the different [chat models](https://learn.microsoft.com/en-us/microsoft-copilot-studio/prompt-model-settings) you can choose from. The default model selected is **Basic GPT-4.1 mini**. You'll see a list of OpenAI models and [Anthropic models](https://learn.microsoft.com/en-us/copilot/microsoft-365/connect-to-ai-subprocessor) that you can select from. You also have the option to bring-your-own-model using Microsoft Foundry Models. We'll stick with the selected default model.
...
### 1.3 Update instructions and test your declarative agent
...
### 1.4 Publish your declarative agent to Microsoft 365 Copilot and Microsoft Teams
...
1. Select **Allow** to give your declarative agent permission to invoke the IT Expert prompt.
      ...
      ![Select allow](assets/3.4_09_AlwaysAllow.png)
...
1. We'll then see our agent load. Let's next test our agent. Enter the following prompt and submit.
...
This is the end of **Lab 01 - Build a declarative agent in Microsoft Copilot Studio for Microsoft 365 Copilot**, select the link below to move to the next lesson.

⏭️ [Move to **Creating a new Solution** lesson](../02-creating-a-solution/README.md)
