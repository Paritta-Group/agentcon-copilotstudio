# 🧰 Mission 03: Using a Pre-Built Agent  
...
⏭️ [Move to **Creating a custom agent from scratch** lesson](../04-create-agent-from-conversation/README.md).
